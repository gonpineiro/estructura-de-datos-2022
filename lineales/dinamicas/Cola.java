...
public class Cola {
    ...
    public Object obtenerFrente() {
        Object retorno = null;
        if (this.frente != null) {
            retorno = this.frente.getElement();
        }
        return retorno;
    }
    ...
    public Cola clone2() {
        ...
        clon.frente = new Nodo(auxiliarColaActual.getElement(), null);
        ...
        while (auxiliarColaActual != null) {
            ...
            auxiliarColaClon.setEnlace(new Nodo(auxiliarColaActual.getElement(), null));
    ...
    public Cola clone() {
        ...
        clon.frente = new Nodo(aux.getElement(), null);
