...
public class Lista{
    ...
    private Nodo invertirPaso(Nodo punteroOriginal,Lista listaClone){
        ...
        Object elemento = punteroOriginal.getElement();
    ...
    public boolean eliminarApariciones(Object elemento){
        ...
        if(this.cabecera != null){
            ...
            while(this.cabecera.getElement().equals(elemento)){
                Nodo nuevo = null;
            ...
            while(aux.getEnlace() != null){
                if(aux.getEnlace().getElement().equals(elemento)){
    ...
    public Lista clone(){
        ...
        if(this.cabecera != null){
            ...
            clon.cabecera = new Nodo(this.cabecera.getElement(), null);
    ...
    public String toString(){
        ...
        if(this.cabecera != null){
            ...
            while(aux != null){
                retorno = retorno + aux.getElement().toString();
                if(aux.getEnlace() != null){
                    retorno += ",";
                }
                aux = aux.getEnlace();
            ...
            while(i < this.longitud){
                if(i % numero == 0){
                    if(nuevaLista.cabecera == null){
                        nuevaLista.cabecera = new Nodo(aux.getElement(), null);
