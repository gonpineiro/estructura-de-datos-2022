...
public class TestGenerico {
        ...
        public static void main(String args[]) {
                ...
                System.out.println("Busco el nivel de raiz. Tiene que dar " + sOk + " --> "
                                + (((int) a.nivel(10) == 0) ? sOk : sErr));
                ...
                System.out.println("Busco el nivel de 9. Tiene que dar " + sOk + " --> "
                                + (((int) a.nivel(9) == 1) ? sOk : sErr));
                ...
                System.out.println("Busco el nivel de 3. Tiene que dar " + sOk + " --> "
                                + (((int) a.nivel(3) == 2) ? sOk : sErr));
                ...
                System.out.println("\n toString()  deberia dar: \n"
                                ...
                                + "\n" + a.toString());
                System.out.println("\n");
                System.out.println("Inserto con padre inexistente. Tiene que dar " + sErr + " --> "
                                + ((a.insertar(5, 50)) ? sOk : sErr));
                System.out.println("Inserto elemento duplicado en pos valida. 10 como hijo de 3. Tiene que dar " + sOk
                                + " --> " + ((a.insertar(10, 3)) ? sOk : sErr));
                System.out.println(
                ...
                b.vaciar();
                System.out.println("Busco al padre 20 en Arbol vacio. Tiene que dar " + sOk + " --> "
                                + ((b.padre(20) == null) ? sOk : sErr));
                System.out.println("Busco a 25 con pertenece. Tiene que dar " + sOk + " ---> "
                                + ((!b.pertenece(20)) ? sOk : sErr));
                ...
                System.out.println("********************************\n");
                System.out.println("Busco al padre de 55. Tiene que dar " + sOk + " --> "
                                + (((int) a.padre(55) == 30) ? sOk : sErr));
                System.out.println("Busco al padre de 20. Tiene que dar " + sOk + " --> "
                                + (((int) a.padre(20) == 15) ? sOk : sErr));
                System.out.println("Busco al padre de raiz. Tiene que dar " + sOk + " --> "
                                + ((a.padre(10) == null) ? sOk : sErr));
                System.out.println("Busco al padre de elemento inexistente. Tiene que dar " + sErr + " --> "
                                + ((a.padre(1011) != null) ? sOk : sErr));
                System.out.println("Busco a raiz con pertenece. Tiene que dar " + sOk + " ---> "
                                + ((a.pertenece(10)) ? sOk : sErr));
                System.out.println("Busco a 55 con pertenece. Tiene que dar " + sOk + " ---> "
                                + ((a.pertenece(55)) ? sOk : sErr));
                System.out.println("Busco a 7 con pertenece. Tiene que dar " + sOk + " ---> "
                                + ((a.pertenece(7)) ? sOk : sErr));
                System.out.println("Busco elemento inexistente con pertenece. Tiene que dar " + sOk + " ---> "
                                + ((!a.pertenece(200)) ? sOk : sErr));
                ...
                System.out.println("Busco ancentros de elemento inexistente deberia dar vacio: "
                                + a.ancestros(3333).toString());
                ...
                System.out.println("Busco el nivel de raiz. Tiene que dar 0: " + sOk + " --> "
                                + (((int) a.nivel(10) == 0) ? sOk : sErr));
                System.out.println("Busco el nivel 3. Tiene que dar 2: " + sOk + " --> "
                                + (((int) a.nivel(3) == 2) ? sOk : sErr));
                System.out.println("Busco el nivel 20. Tiene que dar 2: " + sOk + " --> "
                                + (((int) a.nivel(20) == 2) ? sOk : sErr));
                System.out.println("Busco el nivel 9. Tiene que dar 1: " + sOk + " --> "
                                + (((int) a.nivel(9) == 1) ? sOk : sErr));
                System.out.println("Busco el nivel 22. Tiene que dar 2: " + sOk + " --> "
                                + (((int) a.nivel(22) == 2) ? sOk : sErr));
                System.out.println("Busco el nivel 45. Tiene que dar 3: " + sOk + " --> "
                                + (((int) a.nivel(45) == 3) ? sOk : sErr));
                System.out.println("Busco el nivel 55. Tiene que dar 3: " + sOk + " --> "
                                + (((int) a.nivel(55) == 3) ? sOk : sErr));
                ...
                System.out.println("Grado de árbol completo: Tiene que dar 4: " + sOk + " --> "
                                + (((int) a.grado() == 4) ? sOk : sErr));
                System.out.println("Grado de subarbol con raiz 9: Tiene que dar 2: " + sOk + " --> "
                                + (((int) a.gradoSubarbol(9) == 2) ? sOk : sErr));
                System.out.println("Grado de subarbol con raiz 15: Tiene que dar 4: " + sOk + " --> "
                                + (((int) a.gradoSubarbol(15) == 4) ? sOk : sErr));
                System.out.println("Grado de subarbol con raiz 30: Tiene que dar 3: " + sOk + " --> "
                                + (((int) a.gradoSubarbol(30) == 3) ? sOk : sErr));
                System.out.println("Grado de subarbol con raiz 45: Tiene que dar 0: " + sOk + " --> "
                                + (((int) a.gradoSubarbol(45) == 0) ? sOk : sErr));
                System.out.println("Grado de subarbol con raiz inexistente 90: Tiene que dar -1: " + sOk + " --> "
                                + (((int) a.gradoSubarbol(90) == -1) ? sOk : sErr));
                System.out.println("Grado de árbol vacío: Tiene que dar -1: " + sOk + " --> "
                                + (((int) vacio.grado() == -1) ? sOk : sErr));
        }
